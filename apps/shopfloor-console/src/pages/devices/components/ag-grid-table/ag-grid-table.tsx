...
import CustomDeviceCellRenderer from './device-cell-renderer';
import QuickActionsCellRenderer from './quick-actions-cell-renderer';
...
function AgGridTable() {
  ...
  const { setExpanded, setSelectedDeviceId, selectedDataId } =
    useOverviewPaneStore();
    ...
    <div className="flex-grow-1">
      <AgGridReact
        ...
        doesExternalFilterPass={(e) =>
          doesExternalFilterPass(e as IRowNode<Device>)
        }
      />
    </div>
  );
